...
public class BuscarPorNombre extends EstrategiaDeBusqueda
{
	public BuscarPorNombre(BusinessDelegate bd) 
	{
		super(bd);
	}
	...
	public ArrayList<PeliculaVO> buscar(String param) 
	{
		...
		Collection<PeliculaVO> pelsco = this.getBd().getPeliculasByName(param);
